...
Background _$BackgroundFromJson(Map<String, dynamic> json) => Background()
  ..cardProtobuf = const Uint8ListConverter().fromJson(
    json['cardProtobuf'] as String?,
  )
  ..cardPartnerProtobuf = const Uint8ListConverter().fromJson(
    json['cardPartnerProtobuf'] as String?,
  )
  .._customImage = const Uint8ListConverter().fromJson(
    json['_customImage'] as String?,
  )
...
Map<String, dynamic> _$BackgroundToJson(Background instance) =>
    <String, dynamic>{
      ...
      'cardPartnerProtobuf': const Uint8ListConverter().toJson(
        instance.cardPartnerProtobuf,
      ),
